    ...
    return {
        ...
        controller : ['$scope', function($scope){
            ...
            $scope.getPageList = function(){
                var page = [];
                var firstPage = parseInt(( $scope.pageId ) / $scope._pageSize ) * $scope._pageSize + 1;
                page.push({
                    name    : '首页',
                ...
                page.push({
                    name    : '上一页',
                    style   : $scope.pageId == 1 ? "disabled" : "",
                    link    : $scope.pageId == 1 ? 1:$scope.getLink($scope.pageId - 1)
                });
                ...
                page.push({
                    ...
                    link    : $scope.pageId == $scope.pageCount ? $scope.pageId:$scope.getLink($scope.pageId + 1)
                });
                page.push({
                    name    : '尾页',
                    style   : $scope.pageId == $scope.pageCount ? "disabled" : "",
